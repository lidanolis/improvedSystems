...
public class motherboard implements electronicalStock {

    private static final String STOCKTYPE = "Motherboard";
    ...
    public motherboard(String name, String description, int quantity, String supplierName, String employeeName,
            String location) {
        this.name = name;
    ...
    @Override
    public void getElectronicalStock() {
    ...
    public void generateStock() {
        String filePath = electronicalStock.STORAGE;
