...
public class brushSet implements stationaryStock {

    private static final String STOCKTYPE = "BrushSet";
    ...
    public brushSet(String name, String description, int quantity, String supplierName, String employeeName,
            String location) {
        this.name = name;
