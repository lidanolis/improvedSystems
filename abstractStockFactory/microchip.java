...
public class microchip implements electronicalStock {

    private static final String STOCKTYPE = "Microchip";
    ...
    public microchip(String name, String description, int quantity, String supplierName, String employeeName,
            String location) {
        this.name = name;
